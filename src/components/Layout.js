...
const disclaimerText =
  'IQA and its activities are not licensed by, sponsored by or associated with Warner Bros., J.K.' +
      ...
      <div className="container">
        <div className="columns">
          ...
          >
            ...
            />
            <p className="is-size-7 has-text-white-bis has-text-left">
              {disclaimerText}
            </p>
          </div>
          <div
          ...
          >
            <ul>
              {quickLinksConfig.map(link => (
                <li key={link.slug}>
                  <Link className="has-text-white-ter" to={link.slug}>
                    {link.label}
                  </Link>
                </li>
              ))}
